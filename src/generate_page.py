...
def generate_page(basepath, from_path, template_path, dest_path):
  ...
  # also make sure link and images references are relative to "basepath"
  template_filled = template_filled.replace('href="/', f'href="{basepath}')
  template_filled = template_filled.replace('src="/', f'src="{basepath}')
